...
//		
//		System.out.println("Usr password:" + passwordEncoder().encode("1234"));
//		
	...
	public void configureGlobal(AuthenticationManagerBuilder auth) 
		  throws Exception {
		    ...
		    auth.jdbcAuthentication()
		      ...
		      .usersByUsernameQuery("select name as username, "  
		        + "password, enabled "
		        + "from user_list "
		        + "where name = ?")
		      .authoritiesByUsernameQuery("select name as username, " 
		        + "authority "
		        + "from user_list "
		        + "where name = ?")
